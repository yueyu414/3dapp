...
<head>
    ...
    <title>Models</title>
    <link rel="stylesheet" href="/~yy414/3dapp/assignmnet/Public/css/x3dom.css">
    <!-- Template CSS -->
...
<body>
                    ...
                    <x3d id="x3domOrientationSceneView" width='500px' height='400px'>
                        <scene DEF="scene">
                            ...
                            <Transform id="rotation">
                                ...
                                <inline url="<?php echo ($list[0]['tietu']); ?>" id="tdModels">
                ...
                <div class="col-lg-6 ps-lg-6">
                    ...
                    <div class="anniuceng">
                        ...
                        <div class="anniu" id="anqiuqun">
                            <button class="jingguo" onclick="Texture(<?php echo ($list[0]['id']); ?>)" id="texture"
                                style="background-color:#ffd900">Texture</button>
                            <button class="jingguo" onclick="Grid(<?php echo ($list[0]['id']); ?>)" id="grid">Grid</button>
                            <button class="jingguo" onclick="Protope(<?php echo ($list[0]['id']); ?>)"
    ...
    <script src="/~yy414/3dapp/assignmnet/Public/js/x3dom.js"></script>
